...
class QuarkView
{
    /**
     * Array asociativo
     * Almacena las listas de recursos para las vistas, como archivos css, js, meta tags, etc.
     * 
     * @var array
     */
     ...
     * definidos automaticamente en el scope javascript con QuarkView->includeJsFiles()
     * 
     * @param string $controller_name Nombre del controlador (sin prefijo "Controller")
